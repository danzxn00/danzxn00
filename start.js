...
if (connection == 'open') {
Sky.sendMessage(Sky.user.id.split(":")[0] + "62895417637940@s.whatsapp.net", {text: `${`*#- Simple Botz v5 𝘿𝘼𝙉𝙕𝙓𝙉 𝙎𝙏𝙊𝙍𝙀*

Don't forget to follow to the Channel developer -> https://whatsapp.com/channel/0029VaN28lnGU3BROmG4Tx3j so you can get the latest updates about this script :)`.toString()}`})
